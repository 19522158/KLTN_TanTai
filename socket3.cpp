...
//char *chr1 = "test_";
//char *chr2 = ".jpg";
//const std::string str ="test" + to_string(i) + ".jpg";
//char* chr3 = (char*)i;
//char* filename = new char[strlen(chr1) + strlen(chr2) + 1 + 1];
//strcpy(filename, chr1);
//strcat(filename, chr3);
//strcat(filename, chr2);
